...
data = pd.read_csv("C:\\Users\\darsh\\Desktop\\project\\Food_Recognition_System-WebApp (extract.me)\\Healthy_Diet_Data.csv")
...
data.to_csv(r'C:\Users\darsh\Desktop\project\Food_Recognition_System-WebApp (extract.me)\indian_food.csv', index = False, header=True)
